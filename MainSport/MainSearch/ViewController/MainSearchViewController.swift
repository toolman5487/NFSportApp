...
@MainActor
final class MainSearchViewController: MainBaseViewController, TabBarRootViewController, TabBarRootReselectHandling {
    ...
    private var teams: [MainSearchTeamViewData] = []
    ...
    override func registerReusableViews() {
        collectionView.register(
            MainSearchTeamCell.self,
            forCellWithReuseIdentifier: MainSearchTeamCell.reuseIdentifier
        )
    }
    ...
    private func render(_ state: MainSearchViewState) {
        switch state {
        case .idle:
            teams = []
    ...
    override func collectionView(
        ...
        guard teams.indices.contains(indexPath.item),
              let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: MainSearchTeamCell.reuseIdentifier,
                for: indexPath
              ) as? MainSearchTeamCell else {
