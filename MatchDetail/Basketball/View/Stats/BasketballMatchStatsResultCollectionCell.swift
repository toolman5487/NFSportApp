//
//  BasketballMatchStatsResultCollectionCell.swift
//  NFSportApp
//
...
// MARK: - BasketballMatchStatsResultCollectionCell

final class BasketballMatchStatsResultCollectionCell: UICollectionViewCell {

    // MARK: - Constants

    static let reuseIdentifier = "BasketballMatchStatsResultCollectionCell"
    ...
    private var contents: [BasketballMatchStatsResultContent] = []
    private var currentCollectionViewHeight: CGFloat = 0

    // MARK: - UI Components

    private let leadingTeamLabel = BasketballMatchStatsResultCollectionCell.makeTeamLabel(alignment: .left)
    private let centerTeamLabel = BasketballMatchStatsResultCollectionCell.makeTeamLabel(alignment: .center)
    private let trailingTeamLabel = BasketballMatchStatsResultCollectionCell.makeTeamLabel(alignment: .right)
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(
            BasketballMatchStatsComparisonRowCell.self,
            forCellWithReuseIdentifier: BasketballMatchStatsComparisonRowCell.reuseIdentifier
        )
        collectionView.register(
            BasketballMatchStatsValueRowCell.self,
            forCellWithReuseIdentifier: BasketballMatchStatsValueRowCell.reuseIdentifier
        )
    ...
    func configure(
        contents: [BasketballMatchStatsResultContent],
...
extension BasketballMatchStatsResultCollectionCell: UICollectionViewDataSource {
    ...
    func collectionView(
        ...
        case .comparison(let row):
            guard let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: BasketballMatchStatsComparisonRowCell.reuseIdentifier,
                for: indexPath
            ) as? BasketballMatchStatsComparisonRowCell else {
                return UICollectionViewCell()
            }
        ...
        case .value(let row):
            guard let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: BasketballMatchStatsValueRowCell.reuseIdentifier,
                for: indexPath
            ) as? BasketballMatchStatsValueRowCell else {
                return UICollectionViewCell()
            }
