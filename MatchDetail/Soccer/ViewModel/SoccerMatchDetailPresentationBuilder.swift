//
//  SoccerMatchDetailPresentationBuilder.swift
//  NFSportApp
//
...
// MARK: - SoccerMatchDetailPresentationBuilder

nonisolated struct SoccerMatchDetailPresentationBuilder {
    ...
    func makePresentation(from detail: SoccerMatchDetail) -> SoccerMatchDetailPresentation {
    ...
    private func makeStatsViewData(
        ...
        if displayPolicy.showsDetailedStatistics,
           let (homeStatistics, awayStatistics) = resolveTeamStatistics(
            ...
            let orderedTypes = allTypes.sorted(by: SoccerMatchStatistic.compareDisplayOrder)
