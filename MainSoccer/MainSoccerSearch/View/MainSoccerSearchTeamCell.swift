//
//  MainSoccerSearchTeamCell.swift
//  NFSportApp
//
...
final class MainSoccerSearchTeamCell: UICollectionViewCell {

    // MARK: - Constants

    static let reuseIdentifier = "MainSoccerSearchTeamCell"
    ...
    func configure(with viewData: MainSoccerSearchTeamViewData) {
